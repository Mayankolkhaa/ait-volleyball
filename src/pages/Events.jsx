...
export default function Events() {
  ...
  const liveEventWithScore =
    useMemo(() => {
      ...
      // IMPORTANT:
      // MongoDB Event uses eventId
      // Match also uses eventId

      if (
        Number(liveEvent.eventId) !==
        Number(liveMatch.eventId)
      ) {
        return liveEvent;
      }
      ...
      return {
        ...
        score: {
          ait:
            liveMatch.aitPoints ?? 0,

          opponent:
            liveMatch.opponentPoints ?? 0,
        },

        currentSet:
          liveMatch.currentSet,
  ...
  const visible = useMemo(() => {
    ...
    // Merge live score into the matching event
